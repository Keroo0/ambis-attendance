...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final todayAtt = ref.watch(dashboardTodayAttendanceProvider);
    final recentAtt = ref.watch(dashboardRecentAttendanceProvider);
    final hasFace = ref.watch(dashboardHasFaceDataProvider);
