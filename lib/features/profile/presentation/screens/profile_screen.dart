...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final studentAsync = ref.watch(profileStudentProvider);
    final waliKelas = ref.watch(profileHomeroomTeacherProvider).valueOrNull;
    final gradeSummary = ref.watch(profileGradeSummaryProvider).valueOrNull;
